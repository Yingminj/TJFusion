...
import zmq
import yaml
sys.path.append("/workspace/FlowPose")
...
class FlowPoseServer:
    def __init__(
        ...
        print("[INIT] Creating DinoLoader...")
        self.dino_loader = DinoLoader(device='cuda', local_repo_path="/workspace/model/facebookresearch_dinov2_main") # support local dino model
